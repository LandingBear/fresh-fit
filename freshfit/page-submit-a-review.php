	...
	<main role="main">
		...
		<div class="ff-hero">
			...
			<div class="lb-max-20 lb-header-container">
				<?php if ( get_theme_mod( 'your_theme_header' ) ) : ?>
					...
					<div class="lb-right-column">
						<div class="lb-hero-image" style="background-image: url('<?php echo get_theme_mod( 'your_theme_header' ); ?>')"></div>
					</div>
				<?php endif; ?>
				<?php if ( ! get_theme_mod( 'your_theme_header' ) ) : ?>
		...
		<div class="ff-submit-review-form lb-max-12">
			<?php echo do_shortcode('[TESTIMONIAL_FORM id=687]'); ?>
		</div>
